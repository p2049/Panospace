...
export interface ProfileGradient {
    ...
    topColor: string;
    isDefault: boolean;
    unlockCondition: 'default' | 'free' | 'premium' | 'achievement';
}

export const PROFILE_GRADIENTS: Record<string, ProfileGradient> = {
    'aurora-horizon': {
        id: 'aurora-horizon',
        name: 'Aurora Horizon',
 ...
 * Get gradient by ID
 */
export const getGradient = (gradientId: string | undefined): ProfileGradient => {
    if (!gradientId) return PROFILE_GRADIENTS['aurora-horizon']!;
 ...
 */
export const getGradientBackground = (gradientId: string | undefined): string => {
 ...
 */
export const getDefaultGradientId = (): string => {
 ...
 */
export const getUnlockedGradients = (user: Partial<UserProfile> | null): string[] => {
 ...
 */
export const getCurrentGradientId = (user: Partial<UserProfile> | null): string => {
 ...
 */
export const isGradientUnlocked = (gradientId: string, user: Partial<UserProfile> | null): boolean => {
