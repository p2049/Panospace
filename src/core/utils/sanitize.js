...
export const sanitize = (input, { allowNewLines = true, maxLength = null } = {}) => {
...
export const sanitizeTitle = (input) => sanitize(input, { allowNewLines: false, maxLength: 200 });
export const sanitizeDescription = (input) => sanitize(input, { allowNewLines: true, maxLength: 2000 });
export const sanitizeComment = (input) => sanitize(input, { allowNewLines: true, maxLength: 500 });
export const sanitizeBio = (input) => sanitize(input, { allowNewLines: true, maxLength: 500 });
export const sanitizeDisplayName = (input) => sanitize(input, { allowNewLines: false, maxLength: 50 });
export const sanitizeTag = (input) => sanitize(input, { allowNewLines: false, maxLength: 30 }).toLowerCase();
