/**
 * PANOSPACE PRICING ENGINE & UTILITIES
 * 
 * Single source of truth for all pricing calculations, logic, and formatting.
 * Consolidates product catalog, base pricing, bundle logic, and Printify adapters.
 */

// ============================================================================
// 1. PRODUCT CATALOG & CONSTANTS
// ============================================================================
 ...
 */
export const getPrintifyProducts = () => PRINTIFY_PRODUCTS;
...
/**
 * Safely format a price value (handles undefined, null, strings, numbers)
 */
